  ...
  return (
    <div className="diagonal2  w-full min-h-screen flex flex-col gap-10 text-center">
      ...
      >
        <div
          ref={ref2}
          className="text-green-400 border-2 border-green-400 rounded-full bg-green-400 bg-opacity-10  w-16 h-16 m-auto text-4xl text-center pt-2  "
        >
          2
        </div>
        <p className=" text-green-400 text-3xl font-semibold mt-16 ">
          Projects.
        </p>
        <span className="text-4xl font-semibold sm:text-2xl text-white  ">
          Some of my projects with real clients
        </span>
        ...
        <p className="text-white text-base sm:text-sm md:w-[80%]  lg:w-1/2 sm:w-full m-auto sm:text-center">
          With a strong foundation in these technologies, I deliver scalable,
          high-performance web solutions that exceed client expectations.{" "}
        </p>
      </motion.div>
      <div className="ld:grid lg:grid-cols-3  md:grid md:grid-cols-3 sm:grid sm:grid-cols-1  sm:w-full  p-8  m-auto gap-10 mb-32">
        ...
        <div className="w-52 h-full relative sm:hidden  row-span-2  flex  gap-7 items-center justify-center m-auto">
          ...
          <Image
            ...
            style={{
              ...
              top: `0`,
              left: `50%`,
              transform: `translateX(-50%) translateY(${translationY}px)   translateZ(100px)`,
            }}
          ></Image>
          <Image
        ...
        <Link href={"/projects"}>
          <Card
            ...
            color="green-400"
            title="Espace Bakhta"
            paragraph="Website for a local  event venue with reservation form handled in the admin interface"
            icon="svgexport-13.svg"
            boxs="svgexport-12.svg"
          ></Card>
        </Link>
        <Link href={"/projects"}>
          <Card
            ...
            titleColor="text-[#95D0B4]"
            color="green-400"
            title="Clothify Dashboard"
            paragraph="Meticulously crafted for seamless management of your online clothing store..."
            icon="svgexport-13.svg"
            boxs="svgexport-12.svg"
          ></Card>
        </Link>
        <Link href={"/projects"}>
          <Card
            ...
            titleColor="text-[#95D0B4]"
            color="green-400"
            title="Bakhta Manager"
            paragraph="A management interface the event venue Espace Bakhta..."
            icon="svgexport-13.svg"
            boxs="svgexport-12.svg"
          ></Card>
        </Link>
