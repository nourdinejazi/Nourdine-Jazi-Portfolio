...
const SVGComponent = () => {
  ...
  useEffect(() => {
    function handleScroll() {
      ...
      if (scrollDirection === "down") {
        setrotate((prevrotate) => Math.max(prevrotate - 0.5, 30.4092));
      } else if (scrollDirection === "up") {
        setrotate((prevrotate) => Math.min(prevrotate + 0.5, 46.4092));
      }
  ...
  return (
    <svg
      ...
      style={{
        // ${rotate}
        transform: ` perspective(1200px) translateY(-5px) rotateX(50.4092deg)`,
      }}
    >
