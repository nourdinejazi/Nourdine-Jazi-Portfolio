...
const GitHomePageLinked = () => (
  ...
  >
    ...
    />
    <path
      d="M265.097 305.986a2.5 2.5 0 0 1 2.5-2.5h129.764a2.5 2.5 0 0 1 2.5 2.5v88.236a2.5 2.5 0 0 1-2.5 2.5H267.597a2.5 2.5 0 0 1-2.5-2.5v-88.236Z"
      stroke="#fff"
      strokeOpacity={0.1}
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M262.611 296h141.333a5 5 0 0 1 5 5v103.208H257.611V301a5 5 0 0 1 5-5Zm-6 5a6 6 0 0 1 6-6h141.333a6 6 0 0 1 6 6v103.611h12.778v2.889a3.5 3.5 0 0 1-3.5 3.5H247.333a3.5 3.5 0 0 1-3.5-3.5v-2.889h12.778V301Zm-11.778 104.611h176.889v1.889a2.5 2.5 0 0 1-2.5 2.5H247.333a2.5 2.5 0 0 1-2.5-2.5v-1.889Z"
      fill="url(#rt24cfpuia)"
      fillOpacity={0.4}
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M363.625 311.375h-91.042v1.597h91.042v-1.597Zm-38.334 6.389h-52.708v1.597h52.708v-1.597Zm-52.708 38.333h52.708v1.597h-52.708v-1.597Zm52.708 12.778h-52.708v1.597h52.708v-1.597Zm-52.708-6.389h99.028v1.597h-99.028v-1.597Zm36.736-38.333h-36.736v1.597h36.736v-1.597Zm-36.736 25.555h14.375v1.598h-14.375v-1.598Zm30.347 25.556h-30.347v1.597h30.347v-1.597Zm-30.347 6.389h30.347v1.597h-30.347v-1.597Zm49.514-6.389h-14.375v1.597h14.375v-1.597Zm-14.375 6.389h14.375v1.597h-14.375v-1.597Zm-27.153-51.111h-7.986v1.597h7.986v-1.597Zm27.153 0h23.958v1.597h-23.958v-1.597Zm27.153 12.777h-27.153v1.598h27.153v-1.598Zm-27.153-6.388h35.139v1.597h-35.139v-1.597Zm-4.792-6.389h-17.569v1.597h17.569v-1.597Zm-30.347 6.389h7.986v1.597h-7.986v-1.597Zm30.347 0h-17.569v1.597h17.569v-1.597Zm-30.347 6.388h7.986v1.598h-7.986v-1.598Zm30.347 0h-17.569v1.598h17.569v-1.598Z"
      fill="url(#0uf6dnotqb)"
      fillOpacity={0.25}
    />
    <path opacity={0.5} fill="#fff" d="M325.291 379.652h3.194v1.597h-3.194z" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M664 180.333h-1.125l-57.649 59.529a46.257 46.257 0 0 0-8.516-8.456l58.134-60.03a10.001 10.001 0 0 1 7.184-3.043H664v12ZM530.854 293.96l-61.597 53.54h-50.924v12h51.671a10 10 0 0 0 6.56-2.452l62.299-54.15a46.248 46.248 0 0 1-8.009-8.938Z"
      fill="url(#2dki8t3ltc)"
      fillOpacity={0.1}
    />
    <path
      d="M246.333 353.5H50.902a23.997 23.997 0 0 1-16.513-6.584l-20.902-19.817A24.001 24.001 0 0 1 6 309.682V277.5"
      stroke="url(#am42m9wtod)"
      strokeOpacity={0.05}
      strokeWidth={12}
    />
    <path
      d="M352.833 286v-23.738a24.004 24.004 0 0 1 7.419-17.352L570.876 43.648A23.999 23.999 0 0 1 587.456 37H664"
      stroke="url(#tnrmoyr80e)"
      strokeOpacity={0.05}
      strokeWidth={12}
    />
    <g opacity={0.87} fill="#306EE8">
      <circle
        cx={498.954}
        cy={330.15}
        r={6}
        transform="rotate(-41.604 498.954 330.15)"
      />
      <circle
        opacity={0.4}
        cx={487.322}
        cy={340.479}
        r={6}
        transform="rotate(-41.604 487.322 340.479)"
      />
      <circle
        opacity={0.6}
        cx={493.667}
        cy={334.844}
        r={6}
        transform="rotate(-41.604 493.667 334.844)"
      />
      <circle
        opacity={0.2}
        cx={480.976}
        cy={346.113}
        r={6}
        transform="rotate(-41.604 480.976 346.113)"
      />
      <circle
        opacity={0.1}
        cx={474.632}
    ...
    <defs>
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0.647} stopColor="#fff" />
        <stop offset={1} stopColor="#fff" stopOpacity={0} />
      </linearGradient>
      <linearGradient
        id="zwgg3n8n6f"
...
export default GitHomePageLinked;
