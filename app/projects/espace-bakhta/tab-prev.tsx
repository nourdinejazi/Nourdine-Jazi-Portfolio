        ...
        <div className=" w-full flex items-center justify-center my-4">
          <span className="text-purple-500  flex items-center justify-center gap-2">
            ...
            <Link
              ...
              href="https://espace-bakhta.tn/"
              target="_"
            >
              espace-bakhta.tn <Link2Icon></Link2Icon>
            </Link>{" "}
          </span>
        </div>
        <SimpleSlider />
      ...
      <TabsContent className=" text-slate-300 h-full " value="Description">
        <div className="w-full h-full  mt-16  flex items-start justify-center   ">
          <p className="lg:max-w-[1000px]  md:w-[90%]  sm:w-full text-lg p-2 sm:text-base ">
            Crafted with{" "}
            <span className="text-purple-500">Next js and Tailwind CSS</span>,
            the Espace Bakhta website embodies seamless navigation and elegant
            design. Tailwind CSS adds a touch of finesse with responsive
            layouts.{" "}
            <Link
              className="text-purple-500"
              href="https://www.espace-bakhta.tn/"
            >
              (www.espace-bakhta.tn)
            </Link>
            .
          </p>
        </div>
